...
type Role struct {
	...
	ROLENAME   string `orm:"column(ROLE_NAME);size(50);null" description:"角色名称(初级)"`
	ROLEREMARK string `orm:"column(ROLE_REMARK);size(200);null" description:"备注"`
	ROLESTATE  int    `orm:"column(ROLE_STATE);null" description:"0表示停用1表示启用"`
}
