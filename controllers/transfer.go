...
// @Success 201 {int} models.Transfer
// @Failure 403 body is empty
// @router / [post]
func (c *TransferController) Post() {
	var v models.Transfer
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTransfer(&v); err == nil {
...
func (c *TransferController) GetOne() {
	...
	v, err := models.GetTransferById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
func (c *TransferController) GetAll() {
	...
	l, err := models.GetAllTransfer(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
func (c *TransferController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Transfer{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTransferById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
