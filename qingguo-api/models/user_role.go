...
type UserRole struct {
	Id        int    `orm:"column(USER_ROLE_ID);pk"`
	SUSERID   string `orm:"column(SUSER_ID);size(36);null" description:"系统用户ID"`
	SROLEID   string `orm:"column(SROLE_ID);size(36);null" description:"角色ID"`
	SROLENAME string `orm:"column(SROLE_NAME);size(20);null" description:"角色名（冗余）"`
}
